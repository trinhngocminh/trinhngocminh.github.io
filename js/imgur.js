    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p2 = this.createEls('p', {}, 'Hoặc click vào đây để chọn hình ảnh');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: 'https://raw.githubusercontent.com/ngocminhvn/all/main/svg/loading-spin.svg'});
